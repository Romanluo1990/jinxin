...
public class BuildingPropertyController extends BaseController<BuildingPropertyService>{
    ...
    private BuildingProperty getById(@PathVariable long id){
    ...
    private BuildingProperty saveOrUpdate(@RequestBody BuildingProperty BuildingProperty){
    ...
    private List<BuildingProperty> pageByAccountId(@PathVariable long accountId, @RequestParam(required = false) Date fromDate,
